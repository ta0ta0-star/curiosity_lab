...
URLS = {
    ...
    "published_papers": BASE_URL + "/published_papers?limit=100",
...
def scrape_researchmap():
    ...
    selectors = {
        ...
        "published_papers": "body main div div:nth-of-type(1) section div div:nth-of-type(2) ul li div div:nth-of-type(1) a",
